...
| `talarіаl.sсhооl` | OF — Организация Обучения Квалипио | Институциональный фронт, платное обучение, каталог |
| `edster.cloud` | SaaS — VPS 30€/мес, маржа ~95% | Пространство работы клиента, Stripe + Orange Money (MVP1) |
...
*Код, который мы пишем для себя, является лабораторией для кода, который мы учим других.*
