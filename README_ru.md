...
- **Инструменты разработчика** — повторно используемые плагины Gradle, опубликованные под пространством имен `education.cccp` на [github.com/cccp-education](https://github.com/cccp-education).
