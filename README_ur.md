...
| پلگ ان | رول |
|---|---|
| [`codebase`](https://github.com/cccp-education/codebase-gradle) | بِلڈ-ان ڈویلپمنٹ اسسٹنٹ: پراجیکٹ ریڈنگ، پی جی ویکٹر ریگ، lan چین4ج کنٹیکسٹ اینرچمنٹ، ایس کی ڈوک رپورٹ جنریشن، ڈیٹا سیٹ کریشن۔ |

### کنجرمر — مواد جنریشن (N2)

| پلگ ان | رول |
|---|---|
| [`planner`](https://github.com/cccp-education/planner-gradle) | ایل ایل ایم پرومپٹنگ ایس پی جی/ایس پی ڈی کے لیے ( deepseek-v4-pro) — پلاننگ ماہر نیتی کو ایپکس → یوزر اسٹوریز → گریڈل ٹاسک میں تقسیم کرتا ہے۔ |
| [`codex`](https://github.com/cccp-education/codex-gradle) | ایس کی ڈوکٹر→پی ڈی ایف، سلائیڈز، دستاویز پائپ لائن (ریڈ + ریگ)۔ |
| [`slider`](https://github.com/cccp-education/slider-gradle) | ایس کی ڈوک سورس سے ریویل.جی ایس پریزنٹیشن جنریشن، ایک مخصوص برانچ میں پش کے ساتھ۔ |
| [`plantuml`](https://github.com/cccp-education/plantuml-gradle) | لیم (lan چین4ج، 7 پراوائیڈرز، ریگ پی جی ویکٹر، کی جی، پول ایپی کی کیز) کے ذریعے پلینٹیول سینٹیکس کی تصدیق اور رینڈرنگ (پی این جی/ایس وی جی)۔ |
| [`readme`](https://github.com/cccp-education/readme-gradle) | ایمبیڈیڈ پلا نٹیول ڈائیاگرامس کے ساتھ بہ زبان ریڈمی جنریشن اور گیتہاب پیجز پبلیکیشن جیگٹ کے ذریعے۔ |
| [`bakery`](https://github.com/cccp-education/bakery-gradle) | جی بیک اسٹیٹک سائٹ ایگریگیشن دیگر پلگ انز (ڈائیاگرامس، سلائیڈز، پوسٹس) کے ذریعے پیدا کردہ آرٹی فیکٹس۔ |
...
| پلگ ان | رول |
|---|---|
| [`agile`](https://github.com/cccp-education/agile-gradle) | اے آئی assisted ایگل آرکیسٹریشن: 7 ورکشاپس (ویژن→آرکی ٹیکچر)، بیک لاگ، سپرنٹس، ویلوسٹی، مائل اسٹونز۔ |
| [`ticket`](https://github.com/cccp-education/ticket-gradle) | گیتہاب ٹکٹ تخلیق اینڈ ٹریکنگ — بیک لاگ → ایشو، کیمبن بورڈ، کمیٹ↔ٹکٹ لنکنگ۔ |
...
| پلگ ان | اسٹیٹس |
|---|---|
| `magic-stick` | N2 — ایک ایکس باکس ٹو ایس ایل آئی ایس او بیلڈر (داک سائٹ، نہیں پلگ ان) |
| `newpipe` | N2 — یو ٹیub→ایم پی 3 ایکسٹریکٹر (چھوڑ دیا) |
| `notebook` | N2 — کولاب آbservability (صرف تصور) |
| `office-template` | N? — خالی ٹیمپلیٹ ( حذف کرنے کے لیے) |
---
...
اس پروجیکٹ سے生态系统 کے فلسفے کی نمائش کی جاتی ہے: ورک ماحول خود بھی ایک **قابل دوبارہ تخلیق، ورژن، اور دستاویزات** آرٹی فیکٹس ہے۔ پروجیکٹ کی دستاویزات [`bakery`](https://github.com/cccp-education/bakery-gradle) پر جنریٹ اور شائع ہوتی ہے [cccp.education/magic-stick](https://cccp.education/magic-stick/) پر — ثابت کرنے والی کہ
