...
- **ডেভেলপার টুলিং** — পুনরায় ব্যবহারযোগ্য গ্রেডল প্লাগইন, পরিষ্কার [github.com/cccp-education](https://github.com/cccp-education) এ `education.cccp` নেমস্পেসে প্রকাশিত।
