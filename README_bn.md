...
| `talarіаl.sсhооl` | ওয়েফ — যোগ্যতা ভিত্তিক প্রশিক্ষণ প্রতিষ্ঠান | প্রতিষ্ঠানিক ভিট্রিন, পেয়িং ট্রেনিং, ক্যাটালগ |
| `edster.cloud` | এসএসএ — ভিপিএস ৩০€/মাস, মার্জিন ~৯৫% | গ্রাহক ওয়ার্কস্পেস প্রমুখ, স্ট্রাইপ + অরেঞ্জ মানি (এমভিপি১) |
...
- মাঝারি থেকে উন্নত জাভা (৮ থেকে ২৫) — স্ট্রিম এপিআই থেকে ভার্চুয়াল থ্রেড, রেকর্ড, প্যাটার্ন ম্যাচিং পর্যন্ত।
- মাঝারি থেকে উন্নত কোটলিন — নাল সেফটি, এক্সটেনশন, কোরোটাইন, সিল্ড ক্লাস।
- স্কালা এবং জেভিএম বিল্ড অন্যান্য বিকল্প (মিল, এসবিটি)।
- মেভেন মাল্টি-মডিউল আর্কিটেকচার।
- গ্রেডল কোটলিন ডিএসএল — টাস্ক লেখন থেকে প্রকাশযোগ্য প্লাগইন পর্যন্ত।
- হেক্সাগোনাল আর্কিটেক্চার এবং পরীক্ষা — পোর্টস এবং অ্যাডাপ্টার, জেয়ুনিট ৫, কাকুবার, টেস্টকন্টেনার।
- স্প্রিং বুট — আরএসটি এপিআই, জেডডিএচ সুরক্ষা, ইন্টিগ্রেশন টেস্টিং।
- প্রজেক্ট টুলিং — গিটহাব অ্যাকশন সিআই/সিডি, এক্সিকিউটেবল ডকুমেন্টেশন, কন্টেন্ট জেনারেশন।
...
*যা কোড আমরা নিজেদের জন্য লিখি তা হল অন্যদের শেখানোর কোডের পরীক্ষাগার।*
